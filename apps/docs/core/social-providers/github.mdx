---
title: GitHub
description: GitHub is a social provider for TeamOS.
---

## Overview

GitHub is a social provider for TeamOS. It allows users to sign in to TeamOS using their GitHub account.
...
Once you have configured the social provider, you can sign in to TeamOS using your GitHub account.
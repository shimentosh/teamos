...
const verifyRoute = createRoute({
  ...
  description:
    "Check that the GitHub App is installed on a repository and holds the permissions TeamOS needs. Always 200 -- problems are reported in the body so the client can guide the user.",
  middleware: manageAccess,
  request: {
    body: {
      required: true,

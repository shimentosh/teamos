...
description: Set up your first workspace and project structure in TeamOS
---

This guide covers the first functional setup inside TeamOS so your team can begin tracking work immediately.

...
**Symptoms**:
- Red error message in TeamOS UI
...
<Tip>
Use the "Browse Repositories" feature in TeamOS to see which repositories your app can access.
</Tip>
...
2. **Update Installation**
   ...
   - Go to [GitHub App installations](https://github.com/settings/installations)
   - Click "Configure" on your TeamOS app
...
**Problem**: GitHub events aren't reaching TeamOS.

**Symptoms**:
- Webhook events listed in GitHub but no logs in TeamOS
...
**Problem**: Webhooks reach TeamOS but signature verification fails.
...
**Problem**: Labels aren't syncing between TeamOS and GitHub.

**Symptoms**:
- Changing priority in TeamOS doesn't update GitHub labels
- Adding labels in GitHub doesn't reflect in TeamOS
...
3. **Check Webhook Events**
   ...
   - Without these, label changes from GitHub won't sync to TeamOS
...
2. **Test Repository Access**
   - Use the "Browse Repositories" feature in TeamOS
...
2. **Gather Information**
   ...
   - Check both TeamOS logs and GitHub webhook delivery logs
   - Document your environment (Docker, Kubernetes, etc.)

3. **Test Basic Functionality**
   - Try creating a task without GitHub integration
   - Verify your TeamOS instance is working normally
...
**Still stuck?** The TeamOS community is here to help! Join our [Discord](https://discord.gg/rU4tSyhXXU) for real-time support.
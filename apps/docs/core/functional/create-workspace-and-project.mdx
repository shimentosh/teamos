...
description: Set up your first workspace and project structure in Company OS
---

This guide covers the first functional setup inside Company OS so your team can begin tracking work immediately.

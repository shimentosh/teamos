...
**Symptoms**:
- Red error message in Company OS UI
...
<Tip>
Use the "Browse Repositories" feature in Company OS to see which repositories your app can access.
</Tip>
...
2. **Update Installation**
   ...
   - Go to [GitHub App installations](https://github.com/settings/installations)
   - Click "Configure" on your Company OS app
...
**Problem**: GitHub events aren't reaching Company OS.

**Symptoms**:
- Webhook events listed in GitHub but no logs in Company OS
...
**Problem**: Webhooks reach Company OS but signature verification fails.
...
**Problem**: Labels aren't syncing between Company OS and GitHub.

**Symptoms**:
- Changing priority in Company OS doesn't update GitHub labels
- Adding labels in GitHub doesn't reflect in Company OS
...
3. **Check Webhook Events**
   ...
   - Without these, label changes from GitHub won't sync to Company OS
...
2. **Test Repository Access**
   - Use the "Browse Repositories" feature in Company OS
...
2. **Gather Information**
   ...
   - Check both Company OS logs and GitHub webhook delivery logs
   - Document your environment (Docker, Kubernetes, etc.)

3. **Test Basic Functionality**
   - Try creating a task without GitHub integration
   - Verify your Company OS instance is working normally
...
**Still stuck?** The Company OS community is here to help! Join our [Discord](https://discord.gg/rU4tSyhXXU) for real-time support.
---
title: GitHub
description: GitHub is a social provider for Company OS.
---

## Overview

GitHub is a social provider for Company OS. It allows users to sign in to Company OS using their GitHub account.
...
Once you have configured the social provider, you can sign in to Company OS using your GitHub account.
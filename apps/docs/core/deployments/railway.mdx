---
title: Railway
description: Deploy Company OS to Railway using the official template.
---
## Railway Template

Company OS provides an official Railway template for easy deployment with a single click.
